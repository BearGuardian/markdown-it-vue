...
const highlightPlugin = md => {
  md.renderer.rules.fence = (tokens, idx) => {
    ...
    return `<pre class="hljs"><div style="position: relative;margin-bottom: 16px;"><span class="copy-code-button" data-code="${encodeURIComponent(code)}"style="position: sticky;top: 0;right: 0;padding: 4px 8px;font-size: 12px;cursor: pointer;background-color: #f5f5f5; border: none;border-bottom-left-radius: 4px;">复制代码</span></div><code>${cnt}</code></pre>`
  }
}
